...
You can reuse and tailor to your needs the main sse.py application, however in this repository there is another example `simple.py`, which creates a template, one can easily modify and extend to controll RPI, processes and or GPIOs.
